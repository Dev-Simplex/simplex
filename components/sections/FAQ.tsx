...
export function FAQ({ faqs }: FAQProps) {
  ...
  return (
    <section id="faq" className="py-32 bg-gradient-to-br from-white via-blue-50/20 to-white dark:from-gray-950 dark:via-gray-900/50 dark:to-gray-950 relative overflow-hidden transition-colors duration-300">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <motion.div
            ...
            className="mb-8"
          >
            <Badge variant="secondary" className="bg-gradient-to-r from-primary/5 to-accent/5 dark:from-primary/10 dark:to-accent/10 border-primary/10 dark:border-primary/20">
              <HelpCircle className="w-4 h-4 text-primary dark:text-accent mr-2" />
              Dúvidas Comuns
            </Badge>
          </motion.div>
            ...
            {faqs.map((faq, index) => {
              ...
              return (
                ...
                >
                  ...
                  <AccordionItem
                    value={faq.id}
                    className={`relative bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm border-2 rounded-2xl px-8 py-2 transition-all duration-300 ${isOpen
                  ...
                  >
                    <AccordionTrigger className="text-left hover:no-underline py-6 group/trigger">
                      <div className="flex items-start gap-5 w-full pr-4">
                        ...
                        {/* Question */}
                        <span className={`font-bold text-lg leading-relaxed transition-colors duration-300 ${isOpen
        ...
        >
          <div className="bg-gradient-to-r from-primary/5 to-accent/5 dark:from-primary/10 dark:to-accent/10 border border-primary/10 dark:border-primary/20 rounded-2xl p-8 max-w-2xl mx-auto">
